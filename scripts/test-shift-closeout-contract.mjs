...
assert.match(dashboard, /blockers:\s*Array<\{[\s\S]*proof\?:\s*\{[\s\S]*href:\s*string;[\s\S]*exact:\s*boolean;/, 'Dashboard closeout summary should preserve closeout blocker proof for proactive action evidence.');
