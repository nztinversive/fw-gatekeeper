...
assert.match(dashboardSource, /const trustBrief = shiftBriefing\?\.shift_trust_brief \|\| null/, 'Dashboard should derive command status from the server-backed shift trust brief.');
