...
const checklist = [
  'Use a laptop, tablet, or phone with a working camera.',
    ...
    <div className="animate-fade-in space-y-8">
      ...
      <div className="glass-card p-6 border-l-4 border-gold/70">
        ...
        <p className="text-slate-300 leading-7">
          ...
          the portal. Do <span className="font-semibold text-red-300">not</span> use the Workers page to create new face enrollments;
      ...
      <section className="glass-card p-6">
        ...
        <div className="rounded-2xl border border-navy-600/50 bg-navy-950/60 p-4 text-sm text-slate-300 leading-7">
          ...
          <p className="mt-3">
            Short version: sign in, open <span className="font-semibold text-slate-100">Enroll Face</span>, enter the person’s
            name and department, allow camera access, capture 3 photos, and wait for the success message. Use Workers only
            for reviewing, editing, or deactivating people after enrollment.
          </p>
        </div>
      </section>
    </div>
